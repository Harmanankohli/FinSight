...
# Stub agent_1_adk.agent so api_routes lazy-imports don't trigger real ADK+a2a-sdk
...
if "agent_1_adk.agent" not in sys.modules:
    sys.modules["agent_1_adk.agent"] = _agent_mod_stub
