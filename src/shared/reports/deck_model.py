...
class DeckData:
    ...
    # Slide 2: KPI chips
    kpi_chips: list[dict[str, Any]] = field(default_factory=list)
    ...
    forecast_chart: dict[str, Any] = field(default_factory=dict)
    # Monte Carlo summary
    ...
    reviewer_contradictions: list[dict[str, Any]] = field(default_factory=list)
    reviewer_verifications: list[dict[str, Any]] = field(default_factory=list)
    reviewer_confidence: dict[str, Any] = field(default_factory=dict)
    reviewer_validation: dict[str, Any] = field(default_factory=dict)
