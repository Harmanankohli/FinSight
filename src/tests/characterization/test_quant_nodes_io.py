...
async def test_compute_metrics_output_keys():
    from quant.nodes import compute_metrics_node
...
async def test_stress_test_output_keys():
    from quant.nodes import stress_test_node
...
async def test_format_output_keys():
    from quant.nodes import format_output_node
...
async def test_fetch_price_data_returns_price_data_key():
    ...
    from quant.nodes import fetch_price_data_node
...
async def test_dcf_valuation_output_keys():
    ...
    from quant.nodes import dcf_valuation_node
...
async def test_peer_comparison_output_keys():
    ...
    from quant.nodes import peer_comparison_node
