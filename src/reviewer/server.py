"""FastMCP/ADK server entry point for the Reviewer agent."""
...
agent_card = AgentCard(
    name="Reviewer Agent",
    description=(
        "Cross-validates all agent outputs, checks for contradictions,"
        " and produces calibrated meta-confidence using OpenAI Agents SDK"
    ),
    version="1.0.0",
    ...
    skills=[
        AgentSkill(
            ...
            description=(
                "Cross-agent contradiction detection: quant vs analytics trend,"
                " quant vs RAG sentiment, macro vs quant signal"
            ),
        ...
        AgentSkill(
            ...
            description=(
                "Verify each agent's output for internal consistency"
        ...
        AgentSkill(
            ...
            description=(
                "Aggregate per-agent confidence, agreement score,"
                " data quality, and meta-confidence"
            ),
        ...
        AgentSkill(
            ...
            description=(
                "Gather supporting and contradicting evidence for the quant"
                " recommendation and rate evidence strength"
            ),
        ...
        AgentSkill(
            ...
            description=(
                "Produce a structured meta-review with verdict, flags,"
                " and calibrated confidence for the orchestrator"
            ),
...
if __name__ == "__main__":
    ...
    uvicorn.run(app, host=_settings.host, port=_settings.agent_port_reviewer)
