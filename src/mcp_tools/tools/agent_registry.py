...
from mcp_tools.infra.embed import get_embed_model

logger = logging.getLogger(__name__)

# Agent cards live in the parent project root, not inside mcp_tools/, to keep
# them editable by non-engineers who may not know the server layout.
AGENT_CARDS_DIR = Path(__file__).resolve().parent.parent.parent.parent / "agent_cards"
